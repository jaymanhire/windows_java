...
public class App {
	...
	public static void main(String[] args) {
		...
		// Anonymous implementation of an abstract method listed in the functional interface
		...
		System.out.println("'Vehicle' reversed: " + strRev.stringRev("Vehicle"));
		
		FactorialFinder factorial = (number) -> {
			int result = 1;
		...
		System.out.println("5 factorial: "  + factorial.fact(6));
	}
